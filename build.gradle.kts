...
dependencies {
    shadeMe("org.jetbrains:annotations:26.0.2-1")
    shadeMe("me.hypherionmc.moon-config:core:${orion.getProperty("moon_config")}")
    shadeMe("me.hypherionmc.moon-config:toml:${orion.getProperty("moon_config")}")
    shadeMe("me.hypherionmc.moon-config:json:${orion.getProperty("moon_config")}")
    shadeMe("com.hypherionmc.modutils:mcdiscordformatter:${orion.getProperty("discord_formatter")}")
    shadeMe("net.kyori:adventure-api:${orion.getProperty("adventure")}")
    shadeMe("net.kyori:adventure-text-serializer-gson:${orion.getProperty("adventure")}")
    shadeMe("net.kyori:adventure-text-serializer-plain:${orion.getProperty("adventure")}")
    shadeMe("net.kyori:adventure-text-minimessage:${orion.getProperty("adventure")}")
...
tasks.named<ShadowJar>("shadowJar") {
    ...
    relocate("com.hypherionmc.mcdiscordformatter", "shadow.hypherionmc.mcdiscordformatter")
...
//    multimined.fabric("unimaven.modrinth:player-roles:1.6.15+1.21.6")
//    multimined.fabric("dev.gegy:player-roles-api:1.6.15")
//    // endregion
//
//    // region NeoForge
