...
public class BridgedMinecraftServer implements CraterGameServer {
    ...
    public boolean isPlayerBanned(CraterGameProfile profile) {
        return internal.getPlayerList().getBans().isBanned(((BridgedGameProfile) profile).toNameAndId());
    }
    ...
    public void whitelistPlayer(CraterGameProfile gameProfile) {
        ...
        internal.getPlayerList().getWhiteList().add(new UserWhiteListEntry(((BridgedGameProfile) gameProfile).toNameAndId()));
    }
    ...
    public void unWhitelistPlayer(CraterGameProfile gameProfile) {
        ...
        internal.getPlayerList().getWhiteList().remove(new UserWhiteListEntry(((BridgedGameProfile) gameProfile).toNameAndId()));
    }
    ...
    public void banPlayer(CraterGameProfile profile) {
        internal.getPlayerList().getBans().add(new UserBanListEntry(((BridgedGameProfile) profile).toNameAndId()));
    }
