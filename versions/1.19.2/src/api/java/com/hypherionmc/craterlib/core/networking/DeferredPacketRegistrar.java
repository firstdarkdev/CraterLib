...
public class DeferredPacketRegistrar implements PacketRegistrar {
    ...
    @Override
    public <T> PacketRegistrar registerPacket(CraterIdentifier packetIdentifier, Class<T> messageType, BiConsumer<T, CraterFriendlyByteBuf> encoder, Function<CraterFriendlyByteBuf, T> decoder, Consumer<PacketContext<T>> handler) {
