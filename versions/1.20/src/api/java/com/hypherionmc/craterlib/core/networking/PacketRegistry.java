...
public abstract class PacketRegistry implements CraterNetworkHandler, PacketRegistrar {
    ...
    public <T> PacketRegistrar registerPacket(CraterIdentifier id, Class<T> messageType, BiConsumer<T, CraterFriendlyByteBuf> encoder, Function<CraterFriendlyByteBuf, T> decoder, Consumer<PacketContext<T>> handler) {
