...
dependencies {
    ...
    multimined.shade("me.hypherionmc.sdlink:mcdiscordformatter-1.19.1:${orion.getProperty("discord_formatter")}")
    ...
    multimined.fabric("unimaven.modrinth:player-roles:v1.6.5+1.20")
    multimined.fabric("dev.gegy:player-roles-api:1.6.5")
    // endregion
