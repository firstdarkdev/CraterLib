...
public class Vanish {
    ...
    public static void register() {
        VanishEvents.VANISH_EVENT.register((serverPlayer, b) -> {
            if (b) {
                CraterEventBus.INSTANCE.postEvent(new CraterPlayerEvent.PlayerLoggedOut(BridgedPlayer.wrap(serverPlayer), true));
            } else {
                CraterEventBus.INSTANCE.postEvent(new CraterPlayerEvent.PlayerLoggedIn(BridgedPlayer.wrap(serverPlayer), true));
            }
        });
    }
