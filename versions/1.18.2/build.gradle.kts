...
dependencies {
    ...
    multimined.shade("me.hypherionmc.sdlink:mcdiscordformatter-1.18.1:${orion.getProperty("discord_formatter")}")
    ...
    multimined.fabric("dev.gegy:player-roles:1.5.2")
    multimined.fabric("dev.gegy:player-roles-api:1.5.2")
    // endregion
    ...
    multimined.forge("dev.ftb.mods:ftb-essentials:${orion.getProperty("ftb_essentials")}") // Not Available
    multimined.forge("dev.ftb.mods:ftb-ranks:${orion.getProperty("ftb_ranks")}") // Not Available
