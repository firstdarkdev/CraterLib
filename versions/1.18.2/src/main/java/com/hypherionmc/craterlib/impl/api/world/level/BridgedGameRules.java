...
public class BridgedGameRules implements CraterGameRules {
    ...
    static {
        ...
        register(CraterCommonGameRules.RULE_PROJECTILESCANBREAKBLOCKS, null);
        ...
        register(CraterCommonGameRules.RULE_DISABLE_PLAYER_MOVEMENT_CHECK, null);
        ...
        register(CraterCommonGameRules.RULE_MAX_COMMAND_FORK_COUNT, null);
        register(CraterCommonGameRules.RULE_COMMAND_MODIFICATION_BLOCK_LIMIT, null);
        ...
        register(CraterCommonGameRules.RULE_PLAYERS_NETHER_PORTAL_DEFAULT_DELAY, null);
        register(CraterCommonGameRules.RULE_PLAYERS_NETHER_PORTAL_CREATIVE_DELAY, null);
        ...
        register(CraterCommonGameRules.RULE_DO_WARDEN_SPAWNING, null);
        ...
        register(CraterCommonGameRules.RULE_BLOCK_EXPLOSION_DROP_DECAY, null);
        register(CraterCommonGameRules.RULE_MOB_EXPLOSION_DROP_DECAY, null);
        register(CraterCommonGameRules.RULE_TNT_EXPLOSION_DROP_DECAY, null);
        register(CraterCommonGameRules.RULE_SNOW_ACCUMULATION_HEIGHT, null);
        register(CraterCommonGameRules.RULE_WATER_SOURCE_CONVERSION, null);
        register(CraterCommonGameRules.RULE_LAVA_SOURCE_CONVERSION, null);
        register(CraterCommonGameRules.RULE_GLOBAL_SOUND_EVENTS, null);
        register(CraterCommonGameRules.RULE_DO_VINES_SPREAD, null);
        register(CraterCommonGameRules.RULE_ENDER_PEARLS_VANISH_ON_DEATH, null);
        register(CraterCommonGameRules.RULE_MINECART_MAX_SPEED, null);
